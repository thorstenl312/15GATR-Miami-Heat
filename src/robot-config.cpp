...
motor intakeR = motor(PORT7, ratio6_1, true);
motor stage2 = motor(PORT9, ratio18_1);
motor stage1 = motor(PORT8, ratio6_1);
motor stage3 = motor(PORT6, ratio6_1, true);
motor decide = motor(PORT10, ratio6_1);
